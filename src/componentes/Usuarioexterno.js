...
const Usuarioexterno = ()=> {
    return (
        <section className="u-align-center u-clearfix u-section-1" id="sec-8770">
          ...
          <div className="u-expanded-width u-tab-links-align-left u-tabs u-tabs-1">
            <ul className="u-spacing-10 u-tab-list u-unstyled" role="tablist">
              <li className="u-tab-item u-tab-item-1" role="presentation">
                <a
                  className="active u-active-palette-4-light-2 u-button-style u-tab-link u-text-active-black u-text-black u-tab-link-1"
                  id="tab-6e5a"
                  href="#link-tab-6e5a"
                  role="tab"
              ...
              <li className="u-tab-item u-tab-item-2" role="presentation">
                <a
                  className="u-active-palette-4-light-2 u-button-style u-tab-link u-text-active-black u-text-black u-tab-link-2"
                  id="link-tab-14b7"
                  href="#tab-14b7"
                  role="tab"
              ...
              <li className="u-tab-item u-tab-item-3" role="presentation">
                <a
                  className="u-active-palette-4-light-2 u-button-style u-tab-link u-text-active-black u-text-black u-tab-link-3"
                  id="link-tab-0da5"
                  href="#tab-0da5"
                  role="tab"
              ...
              <li className="u-tab-item" role="presentation">
                <a
                  className="u-active-palette-4-light-2 u-button-style u-tab-link u-text-active-black u-text-black u-tab-link-4"
                  id="link-tab-2917"
                  href="#tab-2917"
                  role="tab"
              ...
              <li className="u-tab-item u-tab-item-5" role="presentation">
                <a
                  className="u-active-palette-4-light-2 u-button-style u-tab-link u-text-active-black u-text-black u-tab-link-5"
                  id="link-tab-b39f"
                  href="#tab-b39f"
                  role="tab"
                  aria-controls="tab-b39f"
                  aria-selected="false"
                >
                  Salir
                </a>
            ...
            <div className="u-tab-content">
              <div
                className="u-align-left u-container-style u-palette-4-light-3 u-tab-active u-tab-pane u-tab-pane-1"
                id="link-tab-6e5a"
                role="tabpanel"
              ...
              <div
                className="u-align-left u-container-style u-palette-4-light-3 u-tab-pane u-tab-pane-2"
                id="tab-14b7"
                role="tabpanel"
              ...
              >
                <div className="u-container-layout u-container-layout-2">
                  <p className="u-text u-text-2">
                    Texto de ejemplo. Lorem ipsum dolor sit amet, consectetur
              ...
              <div
                className="u-align-left u-container-style u-palette-4-light-3 u-tab-pane u-tab-pane-3"
                id="tab-0da5"
                role="tabpanel"
              ...
              <div
                className="u-align-left u-container-style u-palette-4-light-3 u-tab-pane u-tab-pane-4"
                id="tab-2917"
                role="tabpanel"
              ...
              <div
                className="u-align-left u-container-style u-palette-4-light-3 u-tab-pane u-tab-pane-5"
                id="tab-b39f"
                role="tabpanel"
                aria-labelledby="link-tab-b39f"
              >
